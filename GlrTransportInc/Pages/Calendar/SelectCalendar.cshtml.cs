...
{
    public class SelectCalendarModel : PageModel
    {
        ...
        public SelectCalendarModel(GlrTransportInc.Data.ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            //SelectedName = CalendarSelection.SelectedName;
            ...
            foreach (var item in FreightBill)
            {
                ...
                {
                    if (item.Driver == CalendarSelection.Selection)
                    {
                        Id.Add(item.ID);
